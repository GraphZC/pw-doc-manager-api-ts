...
import { CustomerOrderUncheckedUpdateManyWithoutEmployeeNestedInputSchemaObject } from './CustomerOrderUncheckedUpdateManyWithoutEmployeeNestedInput.schema'

export const EmployeeUncheckedUpdateInputSchemaObject = {
...
Joi.object().keys(StringFieldUpdateOperationsInputSchemaObject)),
  ...
  customerOrder: Joi.object().keys(CustomerOrderUncheckedUpdateManyWithoutEmployeeNestedInputSchemaObject)
}