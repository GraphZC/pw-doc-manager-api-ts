...
import { CustomerOrderUpdateManyWithoutCustomerNestedInputSchemaObject } from './CustomerOrderUpdateManyWithoutCustomerNestedInput.schema'

export const CustomerUpdateWithoutPoolInputSchemaObject = {
...
Joi.object().keys(NullableStringFieldUpdateOperationsInputSchemaObject)),
  ...
  customerOrder: Joi.object().keys(CustomerOrderUpdateManyWithoutCustomerNestedInputSchemaObject)
}