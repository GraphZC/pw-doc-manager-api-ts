// @ts-nocheck
import Joi from 'joi';
import { NestedFloatWithAggregatesFilterSchemaObject } from './NestedFloatWithAggregatesFilter.schema';
...
export const FloatWithAggregatesFilterSchemaObject = {
    equals: Joi.number(),
...
Joi.object().keys(NestedFloatWithAggregatesFilterSchemaObject)),
  _count: Joi.object().keys(NestedIntFilterSchemaObject),
  _avg: Joi.object().keys(NestedFloatFilterSchemaObject),
  _sum: Joi.object().keys(NestedFloatFilterSchemaObject),
  _min: Joi.object().keys(NestedFloatFilterSchemaObject),
  _max: Joi.object().keys(NestedFloatFilterSchemaObject)
}