...
import { CustomerOrderUpdateManyWithoutEmployeeNestedInputSchemaObject } from './CustomerOrderUpdateManyWithoutEmployeeNestedInput.schema'

export const EmployeeUpdateInputSchemaObject = {
...
Joi.object().keys(StringFieldUpdateOperationsInputSchemaObject)),
  ...
  customerOrder: Joi.object().keys(CustomerOrderUpdateManyWithoutEmployeeNestedInputSchemaObject)
}