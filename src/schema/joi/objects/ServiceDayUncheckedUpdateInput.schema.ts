...
import { PoolUncheckedUpdateOneWithoutServiceDayNestedInputSchemaObject } from './PoolUncheckedUpdateOneWithoutServiceDayNestedInput.schema'

export const ServiceDayUncheckedUpdateInputSchemaObject = {
...
Joi.object().keys(BoolFieldUpdateOperationsInputSchemaObject)),
  ...
  pool: Joi.object().keys(PoolUncheckedUpdateOneWithoutServiceDayNestedInputSchemaObject)
}