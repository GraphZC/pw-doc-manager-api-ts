...
import { PurchaseUncheckedUpdateManyWithoutProductNestedInputSchemaObject } from './PurchaseUncheckedUpdateManyWithoutProductNestedInput.schema'

export const ProductUncheckedUpdateInputSchemaObject = {
...
Joi.object().keys(StringFieldUpdateOperationsInputSchemaObject)),
  ...
  purchase: Joi.object().keys(PurchaseUncheckedUpdateManyWithoutProductNestedInputSchemaObject)
}